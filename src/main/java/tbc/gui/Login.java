...
/**
 * The first gui window, the login window. After a client is set, this window will open and the
 * username has been set. You can't change your username here, but later on in the lobby or in the
 * game window.
 */
